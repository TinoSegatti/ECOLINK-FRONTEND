...
const {
  ...
  getUniqueValues,
  showPrecioModal, // Destructure here
  setShowPrecioModal, // Destructure here
  precioForm, // Destructure here
  setPrecioForm, // Destructure here
  handleActualizarPrecios, // Destructure here
} = useClientes()
...
return (
  ...
  >
    ...
    <ClientesContainer
      ...
      showPrecioModal={showPrecioModal} // Pass the state from useClientes
      setShowPrecioModal={setShowPrecioModal} // Pass the setter from useClientes
      precioForm={precioForm} // Pass the state from useClientes
      setPrecioForm={setPrecioForm} // Pass the setter from useClientes
      handleActualizarPrecios={handleActualizarPrecios} // Pass the function from useClientes
      userRole={usuario?.rol || RolUsuario.LECTOR} // Ensure userRole is passed correctly
    />
  </div>
)
}
