            ...
            <Row className="g-3">
              ...
              <Col md={4}>
                <Form.Group controlId="horario">
                  <Form.Label className="form-label-custom">
                    <i className="bi bi-clock me-1" style={{ color: "var(--accent-cyan)" }}></i>
                    Horario
                  </Form.Label>
                  <Form.Control
                    type="text"
                    ...
                    onChange={handleChange}
                    name="horario"
                    aria-describedby="horario-desc"
                    className="form-control-custom"
                  />
                  <Form.Text id="horario-desc" className="form-text-custom">
                    Opcional: horario de atención del cliente.
                  </Form.Text>
                </Form.Group>
              </Col>
              <Col md={4}>
              ...
              <Row className="g-3">
                ...
                <Col md={4}>
                  <Form.Group controlId="rubro">
                    <Form.Label className="form-label-custom">
                      <i className="bi bi-briefcase me-1" style={{ color: "var(--accent-blue-gray)" }}></i>
                      Rubro
                    </Form.Label>
                    <Form.Control
                      type="text"
                      ...
                      aria-describedby="rubro-desc"
                      className="form-control-custom"
                    />
                    <Form.Text id="rubro-desc" className="form-text-custom">
                      Opcional: rubro de la empresa.
                    </Form.Text>
                    {errors.rubro && (
                      <div className="text-danger" style={{ fontSize: "0.875rem", marginTop: "0.25rem" }}>
                        <i className="bi bi-exclamation-circle me-1"></i>
                ...
                <Col md={4}>
                  <Form.Group controlId="categoria">
                    <Form.Label className="form-label-custom">
                      <i className="bi bi-tags me-1" style={{ color: "var(--accent-blue-gray)" }}></i>
                      Categoría
                    </Form.Label>
                    <Form.Control
                      type="text"
                      ...
                      aria-describedby="categoria-desc"
                      className="form-control-custom"
                    />
                    <Form.Text id="categoria-desc" className="form-text-custom">
                      Opcional: categoría de la empresa.
                    </Form.Text>
                    {errors.categoria && (
                      <div className="text-danger" style={{ fontSize: "0.875rem", marginTop: "0.25rem" }}>
                        <i className="bi bi-exclamation-circle me-1"></i>
